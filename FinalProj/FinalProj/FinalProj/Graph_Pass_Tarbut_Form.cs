...
namespace FinalProj
{
    public partial class Graph_Pass_Tarbut_Form : Form
    {
        public Graph_Pass_Tarbut_Form()
        {
            InitializeComponent();
        }
        ...
        private void chart1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (myreader.Read())
                {
                    this.chart1.Series["ציוני עוברים"].Points.AddXY(myreader.GetString("Name"),
        ...
        {
            this.Hide();
            ReportForm2 rep2 = new ReportForm2();
            rep2.ShowDialog();
            this.Close();
        }
    }
